...
public class Frag_reservation_fishery extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button product1 = (Button) v.findViewById(R.id.button_product1);
        Button product2 = (Button) v.findViewById(R.id.button_product2);
        Button product3 = (Button) v.findViewById(R.id.button_product3);
        //클릭 이벤트
