...
public class AdapterMain extends BaseExpandableListAdapter {
    ...
    public AdapterMain(Context context,int groupLay,int chlidLay,ArrayList<myGroup> DataList){
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView groupName = (TextView)convertView.findViewById(R.id.home_list_group);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView childName = (TextView)convertView.findViewById(R.id.home_list_child);
